    ...
    <main className="overflow-hidden bg-[#F7F6F2] text-[#0B1B3D]">
        ...
        <div className="relative mx-auto grid min-h-[calc(90vh-6rem)] max-w-7xl items-center gap-12 px-6 py-16 lg:grid-cols-2 lg:px-8">
          ...
          <div className="relative z-20 max-w-2xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <a
                href="#story"
                className="group inline-flex items-center rounded-full bg-gradient-to-r from-[#D4A853] via-[#DFB76C] to-[#C59B3F] px-7 py-3.5 text-sm font-bold text-[#0B1733] shadow-[0_8px_25px_rgba(212,168,83,0.3)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_12px_35px_rgba(212,168,83,0.45)]"
              >
                Read Our Story
      ...
      */}
      <section id="message" className="relative overflow-hidden bg-[#0B1B3D] px-6 py-28 text-white md:px-8">
        ...
        <div className="pointer-events-none absolute -left-20 bottom-10 h-96 w-96 rounded-full bg-[#D4A853]/15 blur-[120px]" />
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            ...
            <div className="lg:col-span-5">
              <div className="relative mx-auto max-w-md">
                ...
                <div className="mt-4 rounded-2xl border border-white/10 bg-white/5 p-4 text-center backdrop-blur-md">
                  <p className="text-sm font-semibold tracking-wide text-white">
                    Principal
                  </p>
      ...
      <section className="bg-[#F7F6F2] px-6 py-28 md:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="relative overflow-hidden rounded-[2.5rem] border border-[#D4A853]/30 bg-gradient-to-br from-[#0B1B3D] via-[#0D214D] to-[#071228] p-8 shadow-2xl md:p-16 lg:p-20">
            ...
            <div className="pointer-events-none absolute -left-20 -top-20 h-64 w-64 rounded-full bg-[#1D4ED8]/20 blur-3xl" />
            <div className="pointer-events-none absolute -bottom-20 -right-20 h-64 w-64 rounded-full bg-[#D4A853]/20 blur-3xl" />
            ...
            <div className="relative z-10 grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
              <div>
                ...
                <h2 className="mt-4 text-4xl font-semibold leading-tight tracking-[-0.05em] text-white sm:text-6xl">
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  href="/#academics"
                  className="rounded-full border border-white/20 bg-white/10 px-8 py-4 text-sm font-semibold text-white backdrop-blur-md transition duration-300 hover:-translate-y-0.5 hover:border-[#D4A853]/40 hover:bg-white/20"
                >
                  Explore Academics
                </Link>
                <Link
                  href="/#admissions"
                  className="rounded-full bg-gradient-to-r from-[#D4A853] via-[#DFB76C] to-[#C59B3F] px-8 py-4 text-sm font-bold text-[#0B1733] shadow-[0_10px_30px_rgba(212,168,83,0.35)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_15px_40px_rgba(212,168,83,0.5)]"
                >
                  Admissions & Enquiry →
                </Link>
              </div>
